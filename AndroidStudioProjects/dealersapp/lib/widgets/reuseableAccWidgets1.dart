...
class ReuseableAccWidget1 extends StatelessWidget {
  String body1;
  String body2;
  String imageUrl1;
  String imageUrl2;
  ...
  ReuseableAccWidget1({required this.body1,required this.body2,required this.imageUrl1,required this.imageUrl2, this.onTap1});
  @override
